...
Du coté du serveur, la génération de la page se fait grâce à symfony via le DefaultController et le moteur de template Twig. Cela nous permet de génerer la page en fonction des informations présentent dans la Base de Données
